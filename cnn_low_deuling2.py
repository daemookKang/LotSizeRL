...
class NN_FABSched(nn.Module):
    def __init__(self, n, output_dim):
        ...
        self.fc1_adv = nn.Linear(4 * n, 100)
        self.fc1_val = nn.Linear(4 * n, 100)
        #         self.fc2 = nn.Linear(500, 100)
        self.fc3_adv = nn.Linear(100, self.output_dim)
        self.fc3_val = nn.Linear(100, 1)
...
#         q_val = val + adv - adv.max().expand(self.output_dim)
#         print(adv.mean(0).expand(self.output_dim))
#         print(adv)
