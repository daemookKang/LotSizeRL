...
class DQN_FS:
    ...
    def get_sars(self,state_lst,action,next_action,time_lst):
        ...
        reward = self.get_reward(time_lst)
    ...
    def cal_loss(self,batch):
        ...
        for data in batch:
            ...
            q = self.model(sa_input)[0][action]
            # print(q)
            ...
            if len(nsa_input) != 0:
                tgt_q = reward + ((self.discount_factor**discount_step) * self.target(nsa_input)[0][next_greedy_action])
                # print(next_greedy_action)
