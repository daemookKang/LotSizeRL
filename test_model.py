...
class FABEnvironment:
    ...
    def set_scenario(self,seed,valid,init_inv=None):
        ...
        min_demand_time, max_demand_time = (4, 4)
        ...
        min_inventory, max_inventory = (40, 60)
    ...
    def simulation_run(self,  max_scenario_num=1):
...
# model.load_state_dict(torch.load("dqntest228job_0.001lr_0.99df_4950epochs_new_inv_setup_1m_lot30.pt"))
model.load_state_dict(torch.load("dqntest228job_0.001lr_0.9df_4950epochs_new_inv_setup_1m_lot20.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.001lr_0.99df_4950epochs_new_inv_setup_1m_lot30.pt"))
...
# model.load_state_dict(torch.load("dqntest228job_0.001lr_0.99df_4950epochs_new_inv_setup_1m.pt"))
...
#
#
env = FABEnvironment(env_type='dqn',dqn_agent=dqn,run_time=1440)
# # env.set_scenario()
env.simulation_run()
