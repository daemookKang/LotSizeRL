...
for lot_size in lot_size_lst:
    for lr in lr_lst:
        for df in df_lst:
            ...
            #
            dqn = DQN_FS(model,learning_rate=lr,discount_rate=df,env_name="_3m9j_reward_demand_new_demand_960day_{}".format(lot_size))
            #
            #
