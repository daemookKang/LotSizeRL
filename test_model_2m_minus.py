...
# model.load_state_dict(torch.load("dqntest228job_0.001lr_0.7df_5000epochs_weight0.1__2m6j_reward_demand_new_demand_960day_50.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.01lr_0.7df_5000epochs_weight0.1__2m6j_reward_inv_new_demand_960day_50.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.001lr_0.99df_1000epochs_weight0.1__2m6j_reward_inv_new_demand_960day_20.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.01lr_0.7df_5000epochs_weight0.1__2m6j_noset_new_demand_960day_50.pt"))
model.load_state_dict(torch.load("dqntest228job_0.01lr_0.8df_4000epochs_weight0.1__2m6j_reward_inv_new_demand_960day_20.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.01lr_0.7df_5000epochs_2m6j_setup_minus_960day_40.pt"))
# model.load_state_dict(torch.load("dqntest228job_0.01lr_0.9df_5000epochs_2m6j_setup_halfday_20.pt"))
